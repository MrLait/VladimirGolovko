...
////            Event eventModel = new Event { Id = (await repository.GetAllAsync()).ToList().Count + 1,
////LayoutId = 2, StartDateTime = DateTime.Today, Description = "Created event", Name = "Test event" };
...
////            // Act
////            var lastEvent = (await repository.GetAllAsync()).Last();
////            Event expectedEvent = new Event { Id = lastEvent.Id,
////StartDateTime = lastEvent.StartDateTime, Description = lastEvent.Description, Name = lastEvent.Name, LayoutId = lastEvent.LayoutId };
