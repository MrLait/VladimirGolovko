...
namespace TicketManagement.IntegrationTests.DataAccess.Repositories.AdoRepositories
{
    ...
    internal class SeatTests : TestDatabaseLoader
    {
        ...
        public async Task InitSeatsAsync()
        {
            ...
            var countAllSeats = (await seatRepository.GetAllAsync()).Last().Id;
        ...
        [Test]
        public async Task GetAllAsync_WhenSeatsExist_ShouldReturnSeatList()
        {
            // Arrange
            var expected = _seats;

            // Act
            var actual = await new AdoUsingParametersRepository<Seat>(MainConnectionString).GetAllAsync();
        ...
        [Test]
        public void GetAllAsync_WhenSeatsIncorrectConnectionSting_ShouldThrowArgumentException()
        {
            // Arrange
        ...
        public async Task CreateAsync_WhenAddSeat_ShouldReturnSeatWithNewSeat()
        {
            ...
            Seat seat = new Seat { Id = (await repository.GetAllAsync()).ToList().Count + 1, Row = 2, AreaId = 2, Number = 2 };
        ...
        public async Task DeleteAsync_WhenExistSeat_ShouldReturnSeatListWithoutDeletedSeat()
        {
            ...
            // Act
            var allSeats = await repository.GetAllAsync();
        ...
        public async Task UpdateAsync_WhenExistSeat_ShouldUpdateLastSeat()
        {
            ...
            // Act
            var lastSeat = (await repository.GetAllAsync()).Last();
