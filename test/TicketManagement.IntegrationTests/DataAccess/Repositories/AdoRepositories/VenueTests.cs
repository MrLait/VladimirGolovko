...
namespace TicketManagement.IntegrationTests.DataAccess.Repositories.AdoRepositories
{
    ...
    {
        [Test]
        public async Task GetAllAsync_WhenVenuesExist_ShouldReturnVenueList()
        {
            // Arrange
            ...
            // Act
            var actual = await new AdoUsingParametersRepository<Venue>(MainConnectionString).GetAllAsync();
        ...
        [Test]
        public void GetAllAsync_WhenVenuesIncorrectConnectionSting_ShouldThrowArgumentException()
        {
            // Arrange
