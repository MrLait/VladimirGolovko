...
IF (DB_ID(N'TicketManagement.Database)') IS NOT NULL) 
BEGIN
    ALTER DATABASE [TicketManagement.Database]
    SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE [TicketManagement.Database];
END

GO
PRINT N'Creating TicketManagement.Database...'
GO
CREATE DATABASE [TicketManagement.Database]
GO
IF EXISTS (SELECT 1
           FROM   [master].[dbo].[sysdatabases]
           WHERE  [name] = N'TicketManagement.Database')
    BEGIN
        ALTER DATABASE [TicketManagement.Database]
            SET AUTO_CLOSE OFF 
...
IF IS_SRVROLEMEMBER(N'sysadmin') = 1
    BEGIN
        IF EXISTS (SELECT 1
                   ...
                   WHERE  [name] = N'TicketManagement.Database')
            BEGIN
                EXECUTE sp_executesql N'ALTER DATABASE [TicketManagement.Database]
    SET TRUSTWORTHY OFF,
        DB_CHAINING OFF 
    WITH ROLLBACK IMMEDIATE';
            END
...
IF (@VarDecimalSupported > 0)
    BEGIN
        EXECUTE sp_db_vardecimal_storage_format N'TicketManagement.Database', 'ON';
    END
